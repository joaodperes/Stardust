...
export let gameData = {
    ...
    buildings: {
        mine: createBuilding("Metal Mine", "Produces metal", 60, 15, 0, 60, 10, 2),
        crystal: createBuilding("Crystal Drill", "Produces crystal", 48, 24, 0, 30, 15, 1),
        deuterium: createBuilding("Deuterium Synthesizer", "Produces deuterium", 225, 75, 0, 10, 25, 3, {
        ...
        robotics: createBuilding("Robotics Factory", "Reduces construction time", 400, 120, 0, 0, 120, 0,"% Time", {
                mine: { 1 : 10 },
                solar: { 10 : 30},
                deuterium: { 10 : 15 }
        })
